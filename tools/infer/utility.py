...
############################################################################################################################
    ...
    # parser.add_argument("--rec_model_dir", type=str,default=r'../../inference/ch_ppocr_mobile_v2.0_rec_infer/')
    ...
    parser.add_argument("--image_dir", type=str, default=r'../../doc/imgs/biaoqian202401040015_2.png')
    parser.add_argument("--rec_algorithm", type=str, default='SVTR_LCNet')
    parser.add_argument("--rec_model_dir", type=str,default=r'../../inference/en_PP-OCRv4_rec_infer/best-smi.onnx')
    parser.add_argument("--rec_image_inverse", type=str2bool, default=True)
    parser.add_argument("--rec_image_shape", type=str, default="3, 48, 320")
    parser.add_argument("--rec_batch_num", type=int, default=6)
    parser.add_argument("--max_text_length", type=int, default=25)
