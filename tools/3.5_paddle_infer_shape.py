...
def parse_arguments():
    ...
    parser.add_argument('--model_dir', default=r'../inferencr/en_PP-OCRv4_rec_export', help='Path of directory saved the input model.')
    ...
    parser.add_argument('--save_dir', default=r'../inferencr/en_PP-OCRv4_rec_export2',
