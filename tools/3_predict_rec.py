...
class TextRecognizer(object):
    ...
    def resize_norm_img(self, img, max_wh_ratio):
        ...
        w=self.rec_image_shape[-1]
        resized_image = cv2.resize(img, (w, 48))
        resized_image = resized_image.astype('float32')
        resized_image = resized_image.transpose((2, 0, 1)) / 255
        resized_image -= 0.5
        resized_image /= 0.5
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_dir", type=str, default=r'./imgs/')
    parser.add_argument("--rec_model_dir", type=str,default=r'../inference/en_PP-OCRv4_rec_export/')
    ...
    parser.add_argument("--rec_char_dict_path",default="../ppocr/utils/en_dict.txt")
    parser.add_argument("--use_space_char", default=False)
