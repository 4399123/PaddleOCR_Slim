...
def parse_arguments():
    ...
    parser.add_argument('--model', default=r'../inference/rec_onnx/best.onnx', help='Path of directory saved the input model.')
    parser.add_argument('--origin_names', default=['x','softmax_2.tmp_0'], help='The original name you want to modify.')
    ...
    parser.add_argument('--save_file', default=r'../inference/rec_onnx/best_rename.onnx', help='Path to save the new onnx model.')
